      ...
      try {
        ...
        if (error) {
          ...
          if (error.message.includes('relation "activities" does not exist') || 
              ...
              error.code === '42P01') {
            console.log('📱 Activities table not found, saving locally only');
        ...
        console.log('📱 Database unavailable, saving locally:', dbError);
        return this.saveActivityLocally(newActivity, userId);
      }
    } catch (error) {
      ...
      try {
        ...
        if (error) {
          ...
          if (error.message.includes('relation "activities" does not exist') || 
              error.message.includes('table') || 
              error.code === '42P01') {
            console.log('📱 Activities table not found, using local storage only');
        ...
        console.log('📱 Database unavailable, using local storage:', dbError);
        return this.getActivitiesFromLocal(userId);
      }
    } catch (error) {
      ...
      try {
        ...
        if (error) {
          ...
          if (error.message.includes('relation "activities" does not exist') || 
              error.message.includes('table') || 
              error.code === '42P01') {
            console.log('📱 Activities table not found, deleting locally only');
        ...
        console.log('📱 Database unavailable, deleting locally:', dbError);
        await this.deleteActivityLocally(id, userId);
      }
    } catch (error) {
